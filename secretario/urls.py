...
urlpatterns = [
    ...
    url(r'^estadisticas/$', views.informe.verEstadisticas, name='estadisticas'),
    url(r'^estadisticas/global', views.informe.estGlobal, name='estGlobal'),
    url(r'^estadisticas/Precurs', views.informe.infPrec, name='infPrec'),
    url(r'^estadisticas/Publicador', views.informe.estPub, name='estPub'),
